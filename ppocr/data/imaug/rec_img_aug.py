...
class RandomRotation(object):
    """
    Randomly rotate the image with a given probability.
    Args:
        prob (float): Probability of applying rotation (default: 0.2 for 20%)
        angle_range (tuple): Range of rotation angles in degrees (default: (0, 360))
        fill_color (tuple): RGB color to fill empty areas after rotation (default: (255, 255, 255) white)
    """
    def __init__(self, prob=0.2, angle_range=(0, 360), fill_color=(255, 255, 255), **kwargs):
        self.prob = prob
    ...
    def __call__(self, data):
        ...
        # Rotate image
        img_rotated = img_pil.rotate(angle, fillcolor=self.fill_color, expand=False)
